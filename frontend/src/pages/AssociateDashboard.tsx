...
const AssociateDashboard = () => {
  ...
  return (
    <div className="min-h-screen retail-bg">
      {/* Header with Store Environment */}
      <div className="retail-header px-4 py-4 relative overflow-hidden">
        {/* Background Store Image */}
        <div 
          className="absolute inset-0 bg-cover bg-center opacity-10"
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=1920&h=400&fit=crop&crop=center')`,
          }}
        ></div>
        
        <div className="max-w-6xl mx-auto flex items-center justify-between relative z-10">
          {/* Left Side - Logo & Title with Store Info */}
          <div className="flex items-center space-x-4">
            <ShelfMindLogo size="md" />
            <div>
              <h1 className="text-2xl font-semibold text-gray-900">ShelfMind Associate</h1>
              <p className="text-gray-600 font-medium">{user.storeName} • Floor Operations</p>
            </div>
            {/* Store Environment Indicator */}
            <div className="hidden md:flex items-center space-x-2 px-3 py-1 bg-green-100 rounded-full">
              <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
              <span className="text-xs font-medium text-green-700">Store Active</span>
            </div>
          </div>
          
          {/* Right Side - Profile with Photo */}
          <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-2 px-3 py-2 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <div className="hidden sm:block">
                ...
                <div className="text-xs text-gray-500">Store Associate</div>
              </div>
            </div>
